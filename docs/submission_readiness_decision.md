...
Honest strongest claim: `Identify when safety filters change the learned mechanism rather than merely clipping actions.` is a plausible branch-structured mechanism for safe robot learning, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
